 ...
 *
 * This is a standalone IIFE — it has no imports from other wp-builder JS
 * modules because it runs on the public front end, not in the editor iframe.
 */
...
( () => {
	...
	// -----------------------------------------------------------------------
	// Node glossary — mirrors constants.js (no imports on the front end).
	// -----------------------------------------------------------------------
	...
	const VOID_NODES = { img: true, input: true, br: true, hr: true, source: true };
